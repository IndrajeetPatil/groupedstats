...
Another thing to note about `grouped_summary` function is that if no `measures` are specified, the function will compute summary for all variables of the specified type (`numeric` or `factor`).
